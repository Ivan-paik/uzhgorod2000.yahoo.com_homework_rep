...
while True:
    try:
        ...
        print("Oh no, please don't stop! (once varning)")  # not resolved second interuption. Endless did not work.
    except:
        print("Oops, something went wrong. All bugs fixed. Can continuation.")  # program with bug autofixing